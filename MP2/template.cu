...
int main(int argc, char **argv) {
  ...
  dim3 grid_size((numCRows + 31)  / 32, (numCColumns + 31) / 32, 1);
  dim3 block_size(32, 32, 1);

  wbTime_start(Compute, "Performing CUDA computation");
  //@@ Launch the GPU Kernel here
  matrixMultiply<<<grid_size, block_size>>>(deviceA, deviceB, deviceC, numARows, numAColumns, numBRows, numBColumns, numCRows, numCColumns);
